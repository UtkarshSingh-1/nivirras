    ...
    <div className="min-h-screen bg-[#F2F4E8] pt-24">
      <div className="max-w-5xl mx-auto px-4 py-12">
        ...
        <div className="text-center mb-16">
          <p className="text-sm uppercase tracking-widest text-[#636B2F] mb-3" style={{ fontFamily: "'Inter', sans-serif" }}>
            Our Story
          </p>
          <h1
          ...
          <p className="text-lg text-[#4A5422] max-w-3xl mx-auto leading-relaxed">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          <Card className="border-[#D3DAAE] bg-white/70">
            <CardHeader>
              <CardTitle className="flex items-center gap-2 text-[#3D2B1F]" style={{ fontFamily: "'Cormorant Garamond', serif" }}>
                <Flame className="h-5 w-5 text-[#8A9353]" />
                Our Mission
              </CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-[#4A5422] leading-relaxed">
          ...
          <Card className="border-[#D3DAAE] bg-white/70">
            <CardHeader>
              <CardTitle className="flex items-center gap-2 text-[#3D2B1F]" style={{ fontFamily: "'Cormorant Garamond', serif" }}>
                <Award className="h-5 w-5 text-[#8A9353]" />
                Our Vision
              </CardTitle>
            </CardHeader>
            <CardContent>
        ...
        <div className="mb-16">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <Card className="border-[#D3DAAE] bg-white/70 text-center">
              <CardHeader>
                <Heart className="h-8 w-8 text-[#8A9353] mx-auto mb-2" />
                <CardTitle className="text-[#3D2B1F]" style={{ fontFamily: "'Cormorant Garamond', serif" }}>
                  Handcrafted with Love
                </CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-[#4A5422] text-sm leading-relaxed">
            ...
            <Card className="border-[#D3DAAE] bg-white/70 text-center">
              <CardHeader>
                <Users className="h-8 w-8 text-[#8A9353] mx-auto mb-2" />
                <CardTitle className="text-[#3D2B1F]" style={{ fontFamily: "'Cormorant Garamond', serif" }}>
                  Community First
                </CardTitle>
              </CardHeader>
            ...
            <Card className="border-[#D3DAAE] bg-white/70 text-center">
              <CardHeader>
                <Award className="h-8 w-8 text-[#8A9353] mx-auto mb-2" />
                <CardTitle className="text-[#3D2B1F]" style={{ fontFamily: "'Cormorant Garamond', serif" }}>
                  Clean & Sustainable
                </CardTitle>
              </CardHeader>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-16">
          {[
            ...
            <div key={stat.label} className="text-center bg-white/70 border border-[#D3DAAE] rounded-xl py-6 px-4">
              <div
                className="text-3xl font-bold text-[#8A9353] mb-1"
                style={{ fontFamily: "'Cormorant Garamond', serif" }}
              >
                {stat.value}
              </div>
              <div className="text-sm text-[#4A5422]">{stat.label}</div>
            </div>
          ))}
        </div>

        {/* Closing */}
        <div className="text-center bg-gradient-to-br from-[#E8ECD6] to-[#D3DAAE] rounded-2xl p-12 border border-[#D3DAAE]">
          <Flame className="h-10 w-10 text-[#8A9353] mx-auto mb-4" />
          <h2
          ...
          <p className="text-[#4A5422] max-w-xl mx-auto leading-relaxed">
